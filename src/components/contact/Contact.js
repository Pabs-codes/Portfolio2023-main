...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/9ec6c3ac-8f28-45ff-a895-5cba5b7fdc36", {
        name: clientName,
        email: email,
        message: messages,
      });
      setSuccessMsg(
        `Hey👋🏼 ${clientName}, Your messages has been sent successfully. 
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full mt-10">
        <Title title="Send a" subTitle="Message" />
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/9ec6c3ac-8f28-45ff-a895-5cba5b7fdc36"
            method="POST"
